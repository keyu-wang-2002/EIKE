...
from transflex_pretrain import Dataset, load_processed, Train
...
def main(margin_ins, margin_sub, in_rate, bern, pnorm):
    ...
    for epoch in [1000, 1500, 2000]:
        ...
        instance_out_dict, subclass_out_dict, m_instance_out_dict, m_subclass_out_dict,delta_ins, delta_sub,  m_delta_ins, m_delta_sub = test_isA(args.dataset, epoch, in_rate)
...
if __name__ == '__main__':
    ...
    print("\n2023/8/18 pretrained sentence-transformer parameters are frozed, eye matrix mapping")
    print("bern=, pnorm=1\n")


    #bern = 0
    #pnorm = 1
    # margin_ins, margin_sub, in_rate
    ...
    for margin_ins, margin_sub, in_rate, bern, pnorm in parameters:
        print("\n margin_ins={0}, margin_sub={1}, in_rate={2}, bern={3}, pnorm={4}".format(margin_ins, margin_sub, in_rate, bern, pnorm))
        main(margin_ins=margin_ins, margin_sub=margin_sub , in_rate=in_rate, bern=bern, pnorm=pnorm)